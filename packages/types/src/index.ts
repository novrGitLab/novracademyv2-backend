...
export const UserRole = {
  ...
  CYBERNOVR_ADMIN: "CYBERNOVR_ADMIN",
  ORG_ADMIN: "ORG_ADMIN",
...
export const ADMIN_ROLES: UserRole[] = [UserRole.SUPER_ADMIN, UserRole.CYBERNOVR_ADMIN, UserRole.ORG_ADMIN, UserRole.INSTITUTION_ADMIN];
