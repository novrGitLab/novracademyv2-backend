...
exports.askCourseAssistant = askCourseAssistant;
const sdk_1 = __importDefault(require("@anthropic-ai/sdk"));
const anthropic = new sdk_1.default({ apiKey: process.env.ANTHROPIC_API_KEY ?? "sk-ant-mock-api-key" });
 ...
 */
async function askCourseAssistant(params) {
    const systemPrompt = [
